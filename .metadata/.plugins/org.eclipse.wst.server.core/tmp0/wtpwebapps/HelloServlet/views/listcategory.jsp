...
<body>
    <div class="container mt-4">
        ...
        <div class="row mb-4">
            <div class="col">
                <a href="<c:url value='/category/add'/>" class="btn btn-primary">
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            <c:forEach items="${cateList}" var="cate" varStatus="STT">
                                <tr>
                                    <td class="text-center align-middle">${STT.index+1}</td>
                                    <td class="text-center">
                                        <c:url value="/image?fname=/${cate.icon}" var="imgUrl"></c:url>
                                        <img class="img-thumbnail" style="max-height: 150px; max-width: 200px;" src="${imgUrl}" alt="${cate.catename}">
                                    </td>
                                    <td class="align-middle">${cate.catename}</td>
